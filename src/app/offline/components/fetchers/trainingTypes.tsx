import { DownloadTrainingTypes } from '@/app/lib/graphQL/query/offline/downloadTrainingTypes'
    ...
    ({ flag }) => {
        ...
        useEffect(() => {
            if (progressBarPercentValue == 100) {
                addSuccessResult('TrainingTypes', 'fetch')
                setStorageItem('TrainingTypes', 'success', '100', 'fetch')
            } else {
                setStorageItem(
                    'TrainingTypes',
                    'fetching',
...
export default FetchTrainingTypes
