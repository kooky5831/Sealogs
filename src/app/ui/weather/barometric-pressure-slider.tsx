...
const BarometricPressureSlider = ({
    disabled = false,
    value = 0,
    onChange,
    unitOfMeasure = '',
    ...
    const handleSliderChange = (value: any) => {
        const barometricPressure = Array.isArray(value) ? value[0] : value
        setSelectedValue(barometricPressure)
        onChange(barometricPressure)
    }
    useEffect(() => {
...
export default BarometricPressureSlider
