            ...
            <div
                ...
                <div className="flex md:items-center flex-col md:flex-row gap-4">
                    {geoLocations && !showLocation && (
                        <Select
                            ...
                            classNames={{
                                control: () =>
                                    'flex py-0.5 md:w-64 !text-sm !bg-transparent !rounded-lg !border !border-slblue-200 focus:ring-blue-500 focus:border-blue-500 dark:placeholder-slblue-400 !dark:text-white !dark:focus:ring-blue-500 !dark:focus:border-blue-500',
                ...
                {newLocation && (
                    <div className="flex flex-col gap-3 mt-5 flex-wrap">
                        ...
                        <div className="flex flex-row gap-3 flex-wrap">
                            <Button className="w-64 mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded text-sm px-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Save Location
                            </Button>
                            <Button
                                className="w-64 mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded text-sm px-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            ...
            <AlertDialog
                ...
                <div className="mb-4 flex items-center">
                    <Select
                        ...
                        classNames={{
                            control: () =>
                                'flex py-1 w-full !text-sm !bg-transparent !rounded-lg !border !border-slblue-200 focus:ring-blue-500 focus:border-blue-500 dark:placeholder-slblue-400 !dark:text-white !dark:focus:ring-blue-500 !dark:focus:border-blue-500',
                            singleValue: () => 'dark:!text-white',
